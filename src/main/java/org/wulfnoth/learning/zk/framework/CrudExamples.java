package org.wulfnoth.learning.zk.framework;
...
public class CrudExamples {
    public static void create(CuratorFramework client,
                              String path,
                              byte[] payload)
            throws Exception {
    ...
    public static void createEphemeral(CuratorFramework client,
                                       String path,
                                       byte[] payload)
            throws Exception {
    ...
    public static void setDataAsync(CuratorFramework client,
                                    String path,
                                    byte[] payload)
            throws Exception {
        ...
        CuratorListener listener = new CuratorListener() {
            ...
            public void eventReceived(CuratorFramework client,
                                      CuratorEvent event)
                    throws Exception {
                System.out.println("aaa => " + event.getType());
    ...
    public static void guaranteedDelete(CuratorFramework client,
                                        String path)
            throws Exception {
    ...
    public static void main(String[] args) throws Exception {
        ...
        client.start();
        create(client, "/test", "bbb".getBytes());
        setDataAsync(client, "/test", "aaa".getBytes());
        Thread.sleep(1000);
